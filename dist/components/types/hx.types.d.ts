...
export type HxProps<T extends keyof JSX.IntrinsicElements, K extends keyof React.CSSProperties> = JSX.IntrinsicElements[T] & HxExtraProps<K>;
export type HxType<T extends keyof React.CSSProperties = never> = {
    <P extends {
        style?: React.CSSProperties;
        children?: React.ReactNode;
    }>(Component: React.ComponentType<P>): React.FC<P & HxExtraProps<T>>;
} & {
