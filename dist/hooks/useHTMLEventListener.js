...
exports.default = useHTMLEventListener;
 ...
 * @returns {void}
 */
function useHTMLEventListener(ref, type, listener, dependency, options) {
    const callback = (0, react_1.useCallback)(listener, [listener, ...dependency]);
