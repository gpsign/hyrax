 ...
 * @returns {void}
 */
export default function useHTMLEventListener<K extends keyof HTMLElementEventMap, T extends HTMLElement = HTMLElement>(ref: HyraxHTMLRef<T>, type: K, listener: (event: HTMLElementEventMap[K]) => void, dependency: React.DependencyList, options?: boolean | AddEventListenerOptions): void;
